...
const Footer = () => {
  return (
    <>
      ...
      <footer className="relative bottom-0 left-0 overflow-hidden w-full bg-gray-200 pt-10">
        <div className="mx-auto w-full max-w-full px-8">
          <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2 logoParent">
